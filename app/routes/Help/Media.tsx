  ...
  return (
    <Stack spacing={5}>
      ...
      <Text>
        ...
        where you can curate your own "Watchlist" for movies and shows you want
        to see, a "Currently Watching" list, and a "Watched" list for those
        you've finished.
      </Text>
      <Text>
      ...
      <Text>
        To add a new item to your own list, press the plus icon on the top left
        of the Media screen. Toggle between <Text as="b">Movie</Text> and{" "}
        <Text as="b">TV Show</Text> and start typing the name of the show or
        movie you are looking for. The list will update in real time. Note that
        the spelling must match, or the serch won't work.
      </Text>
      <Text>
