  ...
  return (
    <Stack spacing={5}>
      ...
      <Text>
        ...
        screen for this - it's the first icon on the left in the bottom nav bar.
      </Text>
      <Text>
      ...
      <Text>
        Next, you can add text to the comment field if you want to add a comment
        or some context. Your friends will see this when they open Cure8, but
        it's not required. There is also a <Text as="b">Save to my links</Text>{" "}
        checkbox which enables you to curate this link for yourself if you wish.
        Note that to save a link, you'll either need to save it to your links or
        select a contact.
      </Text>
      <Text>
        ...
        <Text as="b">Done</Text> when you've selected all the contacts you want
        to curate this content for.
      </Text>
      <Text>
